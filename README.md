...
Clone my repo down from github =>

make sure you are using the most updated node.js and inquirer package =>

navigate to 'utils' directory and run:
...
click on the .gif below and watch my tutorial video.
